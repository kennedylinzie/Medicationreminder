...
import com.greensoft.myapplication.medications_tab.user_medications_model;
...
public class second_prescription {
   ...
   /* public second_prescription(String drug_name, String amount_at_a_time, String total_dosage, String time_a_day, String condtion, String drug_strength, String drug_unit, String needs_refill, String intake_method, String take_with_Pregnancy, String ok_for_breastfeeding, String takeBeforeOrAfterMeal, String patient_ID) {
    ...
    public second_prescription(String drug_name, String amount_at_a_time, String total_dosage, String time_a_day, String condtion, String drug_strength, String drug_unit, String needs_refill, String intake_method, String take_with_Pregnancy, String ok_for_breastfeeding, String takeBeforeOrAfterMeal, String patient_ID, int images) {
        Drug_name = drug_name;
        Amount_at_a_time = amount_at_a_time;
        Total_dosage = total_dosage;
        Time_a_day = time_a_day;
    ...
    public List<second_prescription> populate(){
                ...
                for (int i = 0; i < generalInfoObject.size(); i++) {
                            productList.add(
                                    new second_prescription(
                                            ...
                                            generalInfoObject.get(i).getImages()
